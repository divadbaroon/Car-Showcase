...
const Catalogue = ({ allCars, limit, isLoading }: CatalogueProps) => {
  ...
  return (
    ...
    >
      <h1 className="font-bold text-2xl md:text-4xl ">Discover Our Fleet</h1>
      <p className="mt-2 text-sm md:text-lg">Browse Our Fleet of Luxurious Vehicles to Discover Your Perfect Car</p>
